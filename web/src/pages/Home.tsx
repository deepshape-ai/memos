import DailyLogHomeEntry from "@/components/DailyLogHomeEntry";
...
const Home = () => {
  ...
  const homeFilter = combineFilters(memoFilter, `memo_type != "DAILY_LOG"`);
  ...
  return (
    <div className="w-full min-h-full bg-background text-foreground">
      <PagedMemoList
        ...
        prefixElement={<DailyLogHomeEntry />}
      />
    </div>
  );
};
